fun main() {
    println("Привет! Эта программа - простейший калькулятор с двумя числами (вещественными тоже), вы можете ввести данные через одинарный пробел, в формате \"число число оператор\" (например: 5.5 3.2 +) и получить результат. Попробуйте ;)\n")
    while (true) {
